...
This hub repo is **public** (decision 2026-07-04): no token is needed to
check it out from spoke workflows. Never commit secret values here —
secret scanning and push protection are enabled on this repo.
